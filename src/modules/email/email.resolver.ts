...
export class EmailResolver {
  ...
  @Mutation(() => OkPayload) requestSignupEmailCode(
    ...
    return this.emailService.requestSignupCode(input.email, req.ip);
  }
  ...
  @Mutation(() => OkPayload) requestPasswordReset(
    ...
    return this.emailService.requestPasswordReset(input.email, req.ip);
  }
  @Mutation(() => OkPayload) resetPassword(@Args("input") input: ResetPasswordInput) {
    return this.emailService.resetPassword(input.token, input.password);
  }
}
